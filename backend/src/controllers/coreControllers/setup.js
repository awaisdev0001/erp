...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      tanbits_app_email: email,
      tanbits_app_company_email: email,
      tanbits_app_timezone: timezone,
      tanbits_app_country: country,
      tanbits_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully tanbits App Setup',
  });
};
